...
contract SetToken is ERC20 {
    ...
    */
    ...
    function editExternalPositionUnit(
        ...
        componentPositions[_component].externalPositions[_positionModule]
        ...
        returns (ISetToken.Position[] memory)
    {
        ISetToken.Position[] memory positions =
            new ISetToken.Position[](_getPositionCount());
        ...
        for (uint256 i = 0; i < components.length; i++) {
            ...
            address[] memory externalModules =
                _externalPositionModules(component);
    ...
    {
        return
            componentPositions[_component].externalPositions[_module]
                .virtualUnit;
    }
        ...
        returns (int256)
    {
        ...
        for (uint256 i = 0; i < components.length; i++) {
            ...
            // A default position exists if the default virtual unit is > 0
            uint256 defaultUnit =
                _defaultPositionVirtualUnit(component).toUint256();
